...
return [
    ...
    'attributes'             => [
        ...
        'items.*.category_id' => 'تصنيف الصنف',
        'items.*.main_category_id' => 'التصنيف الرئيسي للصنف',
        'items.*.image' => 'صورة الصنف',
        'items.*.purchase_price' => 'سعر شراء الصنف',
        'items.*.selling_price' => 'سعر بيع الصنف',
        'items.*.wholesale_price' => 'سعر جملة الصنف',
        'items.*.quantity' => 'كمية الصنف',
        'items.*.product_id' => 'المنتج',
        'items.*.qty' => 'كمية الصنف',
        'image' => 'الصورة',
        'address'                  => 'العنوان',
